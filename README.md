...
7
    ...
    fipsfips: A five-digit number (represented as a string) indicating the U.S. county
...
You can read each of the two files using the readRDS()readRDS() function in R.
